...
## Mathematical method PDFs

- [English edition](output/pdf/two_step_gate_grpo_en.pdf)
- [中文版](output/pdf/two_step_gate_grpo_zh.pdf)

The PDFs describe the current two-step gated GRPO method through its update rule. They contain sections 1–6 and no experimental results.
